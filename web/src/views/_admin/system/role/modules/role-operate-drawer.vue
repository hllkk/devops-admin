...
const rules: Record<RuleKey, App.Global.FormRule> = {
  roleId: createRequiredRule($t('page.system.role.form.roleId.required')),
        ...
        <NFormItem path="roleKey">
          <template #label>
            <div class="flex-center">
              <FormTip :content="$t('page.system.role.roleKeyTip')" />
              <span class="pl-3px">{{ $t('page.system.role.roleKeyShort') }}</span>
            </div>
          </template>
