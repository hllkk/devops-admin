...
func NewHuaWeiObsClient() (client *obs.ObsClient, err error) {
	return obs.New(global.OPS_CONFIG.HuaWeiObs.AccessKey, global.OPS_CONFIG.HuaWeiObs.SecretKey, global.OPS_CONFIG.HuaWeiObs.Endpoint)
}
...
func (o *Obs) UploadFile(ctx context.Context, file *multipart.FileHeader) (string, string, error) {
	...
	input := &obs.PutObjectInput{
		PutObjectBasicInput: obs.PutObjectBasicInput{
			ObjectOperationInput: obs.ObjectOperationInput{
				Bucket: global.OPS_CONFIG.HuaWeiObs.Bucket,
				Key:    filename,
			},
	...
	filepath := global.OPS_CONFIG.HuaWeiObs.Path + "/" + filename
