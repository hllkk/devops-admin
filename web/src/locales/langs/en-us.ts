  ...
  page: {
    ...
    system: {
      ...
      setting: {
        general: 'General',
        security: 'Security',
        generalDesc: 'Site info, captcha, log retention',
        securityDesc: 'Password policy, login lock, IP validation',
        save: 'Save',
        ...
        captchaType: { click: 'Click', slide: 'Slide', dragdrop: 'Drag & Drop', rotate: 'Rotate' },
