...
func (i *initDict) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	dictDatas := []sysModel.SysDictData{
		...
		{DictSort: 1, DictLabel: "dict.sys_notice_status.notice", DictValue: "1", DictType: "sys_notice_status", ListClass: "warning", Remark: "通知"},
		{DictSort: 2, DictLabel: "dict.sys_notice_status.announcement", DictValue: "2", DictType: "sys_notice_status", ListClass: "success", Remark: "公告"},
		...
		{DictSort: 1, DictLabel: "dict.sys_show_hide.show", DictValue: "1", DictType: "sys_show_hide", ListClass: "primary", IsDefault: "Y", Remark: "显示菜单"},
		{DictSort: 2, DictLabel: "dict.sys_show_hide.hide", DictValue: "2", DictType: "sys_show_hide", ListClass: "error", IsDefault: "N", Remark: "隐藏菜单"},
