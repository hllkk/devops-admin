      ...
      <NCollapseItem :title="$t('common.search')" name="user-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            ...
            <NFormItemGi span="24 s:12 m:6" :label="$t('page.system.role.roleKeyShort')" path="roleKey" class="pr-24px">
            ...
            <NFormItemGi span="24 s:12 m:6" :label="$t('page.system.role.createTime')" path="createTime" class="pr-24px">
              <NDatePicker
