const local: App.I18n.Schema = {
  ...
  upgrade: {
    ...
    startFail: 'Failed to start upgrade',
    foundNewVersion: 'New version available',
    startNow: 'Upgrade Now',
    startNowTip: 'The service will restart briefly during the upgrade. Save your work first',
    progressTitle: 'Online Upgrade Progress',
    stageIdle: 'Idle',
    stageDownloading: 'Downloading upgrade package',
    stageVerifying: 'Verifying upgrade package',
    stageUnpacking: 'Unpacking upgrade package',
    stageInstalling: 'Installing new version',
    stageSuccess: 'Upgrade completed',
    stageFailed: 'Upgrade failed',
    stageUnreachable: 'Upgrade service unreachable',
    successTip: 'Upgrade completed and service restarted. Force refresh the page if the old UI is still shown',
    unreachableTip: 'Upgrade executor unreachable: updater not deployed or current version predates it',
    processingTip: 'Upgrade in progress. You can close this dialog; confirm the version in "About" later',
  ...
  page: {
    ...
    home: {
      ...
      square: {
        ...
        filterSkills: 'Skills',
        searchPlaceholderSkill: 'Search skill name / author',
        emptySkills: 'No visible skills',
        ...
        accessModelKeyTip: 'For both OpenAI-compatible and Anthropic clients',
    ...
    gateway: {
      ...
      mcp: {
        ...
        publish: {
          ...
          mixedRequired: 'Select at least one department or user for dept + user visibility',
          requiresApproval: 'Approval Required',
      ...
      skill: {
        title: 'Skills',
        subtitle: 'Enterprise AI skill packages: register/publish/distribute; zips download via the authenticated platform endpoint, approval-required skills need a grant first',
        add: 'Register Skill',
        edit: 'Edit Skill',
        ...
        col: {
          ...
          iconUrl: 'Icon URL',
          documentationUrl: 'Docs URL',
          agentInstallPrompt: 'Agent Install Prompt',
          usageInstructions: 'Usage Instructions',
          zipPackage: 'Package',
          zipOriginName: 'File Name',
          zipSize: 'Size',
      ...
      aiKey: {
        ...
        batchScene: {
          title: 'Batch Create Scene Keys',
          nameTemplate: 'Name Template',
          nameTemplatePlaceholder: 'e.g. {username}-crawler',
          nameTemplateTip: 'Supports {username} (login name) / {nickname} placeholders, rendered per user',
          nameTemplateRequired: 'Please enter a name template',
          submit: 'Start Creating',
          tip: 'Creates one personal scene key per selected user; names rendered from the template, resource config (models/MCP/skills/budget/rate limit/expiry) applied as a whole; disabled users or name conflicts go to failures.',
          result: 'Done: {created} created, {failed} failed'
        },
        rotate: 'Rotate',
        ...
        batchSceneCreate: 'Batch Create Scene Keys',
        copyTemplate: 'Use as Template',
        resync: 'Resync',
        ...
        form: {
          ...
          skillsPlaceholder: 'Select authorized skills (main keys default to visible no-approval skills)',
          budgetHardLimitDesc:
    ...
    system: {
      ...
      setting: {
        ...
        tabNotifyWecom: 'WeCom',
        tabNotifyMorning: 'TokenPlan Report',
        notifyWecomPushEnabled: 'Enable app message push',
        notifyWecomPushTip:
          'Credentials reuse the WeCom section of Auth Setting; members must be within app visibility and have logged in via WeCom scan. Unbound users are skipped.',
        notifyWecomRedirectBase: 'Redirect base URL',
        notifyWecomRedirectBasePlaceholder: 'https://your-domain (empty = plain text message)',
        notifyWecomMaxTargets: 'Max targets per push',
        notifyPushBudgetAlertEnabled: 'Budget alert push (soft warn / hard limit)',
        notifyWecomTestUser: 'Test recipient',
        notifyWecomTestUserPlaceholder: 'Select a user bound to WeCom',
        notifyWecomTestBtn: 'Send Test',
        notifyWecomTestSuccess: 'Test message sent',
        notifyWecomTestFail: 'Test message failed',
        notifyWecomAppSection: 'App Message',
        notifyWecomBotSection: 'Group Bot',
        notifyWecomBotEnabled: 'Enable group bot',
        notifyWecomBotGroupTip:
          'Register group bot names and webhook URLs (obtained by adding a bot in the group chat); bot messages such as morning reports will be sent to the selected groups',
        notifyWecomBotGroupAdd: 'Add Group',
        notifyWecomBotGroupAddTitle: 'Add Target Group',
        notifyWecomBotGroupName: 'Group Name',
        notifyWecomBotGroupNamePlaceholder: 'Enter group name, e.g. AI Platform Notice',
        notifyWecomBotWebhook: 'Webhook URL',
        notifyWecomBotWebhookPlaceholder: 'https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=xxx',
        notifyWecomBotGroupCreatedAt: 'Created At',
        notifyWecomBotGroupDeleteConfirm: 'The group will no longer receive bot messages after deletion. Confirm?',
        notifyWecomBotTest: 'Test Send',
        notifyWecomBotTestSelect: 'Select a group to test',
        notifyWecomBotTestBtn: 'Send test to group',
        notifyWecomBotTestSuccess: 'Test message sent to group',
        notifyWecomBotTestFail: 'Test message failed',
        notifyMorningEnabled: 'Enable morning report',
        notifyMorningSendTime: 'Send time (weekdays)',
        notifyMorningTargetType: 'Send to',
        notifyMorningTargetAll: 'Everyone',
        notifyMorningTargetDepts: 'Departments (incl. sub-depts)',
        notifyMorningTargetUsers: 'Specific users',
        notifyMorningTargetIds: 'Targets',
        notifyMorningChannels: 'Push Channels',
        notifyMorningChannelWecomApp: 'WeCom App Message',
        notifyMorningChannelWecomBot: 'WeCom Group Bot',
        notifyMorningChannelTip:
          'In-app notice is always sent; a checked channel also requires its global switch enabled on the WeCom tab',
        notifyMorningBotGroups: 'Target Groups',
        notifyMorningTemplateTitle: 'Message Templates',
        notifyMorningTemplateVars: 'Available Variables',
        notifyMorningTemplateContent: 'Plain Text Template (in-app + app message)',
        notifyMorningTemplateMarkdown: 'Markdown Template (group bot)',
        notifyMorningTemplateReset: 'Reset to Default',
        notifyMorningTemplateVarProviderName: 'Provider name',
        notifyMorningTemplateVarUsedPercent: 'Usage percent (e.g. 45.2)',
        notifyMorningTemplateVarSurplus: 'Remaining credits',
