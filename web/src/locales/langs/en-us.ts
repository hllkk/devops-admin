  ...
  page: {
    ...
    system: {
      ...
      setting: {
        ...
        tabNotifyWecom: 'WeCom App',
        tabNotifyWecomBot: 'Group Bot',
        ...
        notifyMorningPushEnabled: 'Push via external channels (WeCom app/bot)',
        notifyMorningTip:
          'On weekdays at the configured time, summarizes Bailian TokenPlan seats + shared packages remaining and reset date, then pushes to target departments/users; changing send time takes effect after save (timed task schedule is synced). In-app notice is always sent; external channels require their own switches.',
        // Auth config
