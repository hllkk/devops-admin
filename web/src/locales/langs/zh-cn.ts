const local: App.I18n.Schema = {
  ...
  upgrade: {
    ...
    startNow: '立即升级',
    startNowTip: '升级期间服务会短暂重启，请先保存手头工作',
    progressTitle: '在线升级进度',
    stageIdle: '待机中',
    stageDownloading: '下载升级包',
    stageVerifying: '校验升级包',
    stageUnpacking: '解压升级包',
    stageInstalling: '安装新版本',
    stageSuccess: '升级完成',
    stageFailed: '升级失败',
    stageUnreachable: '升级服务不可达',
    successTip: '升级完成，服务已重启；若页面仍显示旧界面请强制刷新',
    unreachableTip: '升级执行器不可达：未部署 updater 或尚未升级到带升级器的版本',
    processingTip: '升级进行中，可关闭弹窗后台等待，完成后在「关于」确认版本',
    background: '后台运行'
  },
  common: {
    action: '操作',
  ...
  page: {
    ...
    home: {
      ...
      square: {
        ...
        filterMcps: 'MCP 工具',
        filterSkills: '技能',
        searchPlaceholderSkill: '搜索技能名称 / 作者',
        emptySkills: '暂无可见技能',
        skillDownload: '下载',
        ...
        accessModelKeyTip: 'OpenAI 兼容与 Anthropic 格式客户端通用',
    ...
    gateway: {
      ...
      skill: {
        title: 'Skill 管理',
        subtitle: '企业内 AI 技能包统一注册/发布/分发；zip 包经平台鉴权端点下载，需审批技能须授权后方可下载',
        add: '注册 Skill',
        edit: '编辑 Skill',
        actionDownload: '下载',
        ...
        col: {
          ...
          iconUrl: '图标地址',
          documentationUrl: '文档地址',
          agentInstallPrompt: 'Agent 安装提示词',
      ...
      aiKey: {
        ...
        batchScene: {
          title: '批量建场景 Key',
          nameTemplate: '名称模板',
          nameTemplatePlaceholder: '如 {username}-爬虫',
          nameTemplateTip: '支持 {username}(登录名) / {nickname}(昵称) 占位符，逐用户渲染',
          nameTemplateRequired: '请输入名称模板',
          submit: '开始创建',
          tip: '为所选目标每人创建一个个人场景 Key，名称按模板渲染，资源配置（模型/MCP/Skill/预算/限流/过期）整体套用；停用用户或同名冲突计入失败明细。',
          result: '创建完成：成功 {created}，失败 {failed}'
        },
        rotate: '轮换',
        rotateConfirm: '轮换后旧 Key 立即失效，新 Key 明文仅用户本人可在首页查看。确认轮换？',
        rotateSuccess: '轮换成功，请通知用户在首页查看新 Key',
        batchSceneCreate: '批量建场景 Key',
        copyTemplate: '以此为模板建 Key',
        resync: '重新同步',
    ...
    system: {
      ...
      setting: {
        ...
        tabNotifyWecom: '企业微信',
        tabNotifyMorning: 'TokenPlan 晨报',
        notifyWecomPushEnabled: '启用应用消息推送',
        notifyWecomPushTip:
          '凭证复用「认证配置」的企业微信段；目标成员需在应用可见范围内并经企微扫码登录，未绑定者自动跳过。',
        notifyWecomRedirectBase: '消息跳转基础地址',
        notifyWecomRedirectBasePlaceholder: 'https://your-domain（留空则降级为纯文本消息）',
        notifyWecomMaxTargets: '单次推送人数上限',
        notifyPushBudgetAlertEnabled: '预算告警推送（软限预警/硬限超限）',
        notifyWecomTestUser: '测试收件人',
        notifyWecomTestUserPlaceholder: '选择已绑定企业微信的用户',
        notifyWecomTestBtn: '发送测试',
        notifyWecomTestSuccess: '测试消息已发送',
        notifyWecomTestFail: '测试消息发送失败',
        notifyWecomAppSection: '应用消息',
        notifyWecomBotSection: '群机器人',
        notifyWecomBotEnabled: '启用群机器人',
        notifyWecomBotGroupTip: '录入群机器人的群聊名称与 Webhook 地址（在群内添加机器人获取），晨报等群机器人消息将发送到指定群',
        notifyWecomBotGroupAdd: '新增群',
        notifyWecomBotGroupAddTitle: '新增接收群',
        notifyWecomBotGroupName: '群聊名称',
        notifyWecomBotGroupNamePlaceholder: '请输入群聊名称，如：AI 平台通知群',
        notifyWecomBotWebhook: 'Webhook 地址',
        notifyWecomBotWebhookPlaceholder: 'https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=xxx',
        notifyWecomBotGroupCreatedAt: '创建时间',
        notifyWecomBotGroupDeleteConfirm: '删除后该群将不再接收群机器人消息，确认删除？',
        notifyWecomBotTest: '测试发送',
        notifyWecomBotTestSelect: '选择要测试的群',
        notifyWecomBotTestBtn: '发送测试到群',
        notifyWecomBotTestSuccess: '测试消息已发送到群',
        notifyWecomBotTestFail: '测试消息发送失败',
        notifyMorningEnabled: '启用晨报',
        notifyMorningSendTime: '发送时间（工作日）',
        notifyMorningTargetType: '发送目标',
        notifyMorningTargetAll: '全员',
        notifyMorningTargetDepts: '按部门（含子部门）',
        notifyMorningTargetUsers: '指定用户',
        notifyMorningTargetIds: '目标范围',
        notifyMorningChannels: '推送渠道',
        notifyMorningChannelWecomApp: '企业微信应用消息',
        notifyMorningChannelWecomBot: '企业微信群机器人',
        notifyMorningChannelTip: '站内通知始终发送；勾选的渠道需在「企业微信」页启用对应渠道总开关',
        notifyMorningBotGroups: '接收群',
        notifyMorningTemplateTitle: '正文模板',
        notifyMorningTemplateVars: '可用变量',
        notifyMorningTemplateContent: '纯文本模板（站内+应用消息）',
        notifyMorningTemplateMarkdown: 'Markdown 模板（群机器人）',
        notifyMorningTemplateReset: '恢复默认',
        notifyMorningTemplateVarProviderName: '供应商名称',
        notifyMorningTemplateVarUsedPercent: '使用率（数值，如 45.2）',
        notifyMorningTemplateVarSurplus: '剩余额度',
        notifyMorningTemplateVarTotal: '总额度',
        notifyMorningTemplateVarResetLine: '重置日文案（可能为空）',
        notifyMorningTemplateVarOverdrawn: '是否已超量',
        notifyMorningTemplateVarJumpUrl: 'AI 身份页跳转链接（跳转地址未配置时为空，仅群机器人 markdown 使用）',
        notifyMorningTemplateTip: 'Go 模板语法，留空使用默认模板，渲染失败自动降级默认模板',
        notifyMorningTip:
          '工作日按配置时间汇总百炼 TokenPlan 坐席+共享包余量与重置日，推送给目标部门/用户；修改发送时间保存后即生效（同步定时任务调度）。站内通知始终发送，外部渠道按上方勾选发送。',
        // 认证配置
      ...
      dept: {
        ...
        collapseAll: '折叠全部',
        syncWecom: '同步企业微信',
        syncInProgress: '通讯录同步正在进行中，请等待完成',
        syncStarted: '通讯录同步任务已开始，完成后自动刷新',
        syncTimeout: '通讯录同步超时，请稍后查看结果或重试',
        syncPollFailed: '同步状态查询失败，请检查权限后重试',
        syncDone: '同步完成：部门新增 {deptCreated}、更新 {deptUpdated}；用户新增 {userCreated}、更新 {userUpdated}、复职恢复 {userRestored}、离职停用 {userDisabled}；岗位新增 {postCreated}',
        empty: '暂无部门数据',
        addDept: '新增部门',
        editDept: '编辑部门',
        placeholder: {
