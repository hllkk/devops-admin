...
import WecomLogin from './modules/wecom-login.vue';
...
const moduleMap: Record<UnionKey.LoginModule, LoginModule> = {
  ...
  'wecom-login': { label: loginModuleRecord['wecom-login'], component: WecomLogin }
};
...
<template>
  <div class="scroll box-border size-full flex">
    ...
    <div class="relative h-full flex-1 flex flex-col xl:m-auto sm:!w-full">
      ...
      <main class="m-auto h-630px max-w-450px w-full rounded-5px bg-cover px-24px xl:absolute xl:inset-0">
