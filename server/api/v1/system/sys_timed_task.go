...
// @accept    application/json
// @Produce   application/json
// @Param     name          query  string  false  "任务名(模糊)"
// @Param     executorType  query  string  false  "执行器类型 method/http"
// @Param     enabled       query  bool    false  "是否启用"
// @Param     pageNum       query  int     true   "页码"
// @Param     pageSize      query  int     true   "每页大小"
// @Success   200  {object}  response.Response{data=response.PageResult{rows=[]response.SysTimedTaskRow},msg=string}
...
// @Param     status   query  string  false  "状态 success/fail/timeout"
// @Param     pageNum  query  int     true   "页码"
// @Param     pageSize query  int     true   "每页大小"
// @Success   200  {object}  response.Response{data=response.PageResult{rows=[]system.SysTimedTaskLog},msg=string}
...
// @Security  ApiKeyAuth
// @Produce   application/json
// @Success   200  {object}  response.Response{data=map[string][]task.TaskMeta,msg=string}  "获取成功"
