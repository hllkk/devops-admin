...
import (
	...
	commonResp "github.com/hllkk/devops-admin/server/model/common/response"
...
func buildLLMAutoPath(llm common.JSONMap) (string, error) {
	if global.OPS_CONFIG.AutoCode.AiPath == "" {
	...
	return strings.ReplaceAll(global.OPS_CONFIG.AutoCode.AiPath, "{FUNC}", mode), nil
}
