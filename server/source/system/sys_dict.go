...
func (i *initDict) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	dictDatas := []sysModel.SysDictData{
		...
		{DictSort: 1, DictLabel: "dict.sys_notice_type.notice", DictValue: "1", DictType: "sys_notice_status", ListClass: "warning", Remark: "通知"},
		{DictSort: 2, DictLabel: "dict.sys_notice_type.announcement", DictValue: "2", DictType: "sys_notice_status", ListClass: "success", Remark: "公告"},
