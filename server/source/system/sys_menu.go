...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	childMenus := []sysModel.SysMenu{
		...
		// ── AI 网关(gateway 父菜单为 M 目录,下挂 5 个独立管理页) ──
		{
			ParentId:  menuNameMap["route.gateway"],
			MenuName:  "route.gateway_provider",
			MenuType:  "C",
			Path:      "gateway/provider",
			ApiPrefix: "/gateway/provider, /gateway/provider/*",
			Component: "_gateway/gateway/provider/index",
		...
		{
			ParentId:  menuNameMap["route.gateway"],
			MenuName:  "route.gateway_credential",
			MenuType:  "C",
			Path:      "gateway/credential",
			ApiPrefix: "/gateway/credential, /gateway/credential/*",
			Component: "_gateway/gateway/credential/index",
		...
		{
			ParentId:  menuNameMap["route.gateway"],
			MenuName:  "route.gateway_model",
			MenuType:  "C",
			Path:      "gateway/model",
			ApiPrefix: "/gateway/model, /gateway/model/*",
			Component: "_gateway/gateway/model/index",
			Icon:      "mdi:brain",
			Visible:   "0",
			OrderNum:  3,
			Module:    "gateway",
		...
		{
			ParentId:  menuNameMap["route.gateway"],
			MenuName:  "route.gateway_ai-key",
			MenuType:  "C",
			Path:      "gateway/ai-key",
			ApiPrefix: "/gateway/ai-key, /gateway/ai-key/*",
			Component: "_gateway/gateway/ai-key/index",
		...
		{
			ParentId:  menuNameMap["route.gateway"],
			MenuName:  "route.gateway_dashboard",
			MenuType:  "C",
			Path:      "gateway/dashboard",
			ApiPrefix: "/gateway/dashboard, /gateway/dashboard/*",
			Component: "_gateway/gateway/dashboard/index",
			Icon:      "mdi:chart-line",
			Visible:   "0",
			OrderNum:  5,
			Module:    "gateway",
