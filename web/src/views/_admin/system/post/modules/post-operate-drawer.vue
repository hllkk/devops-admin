...
const rules: Record<RuleKey, App.Global.FormRule> = {
  postId: createRequiredRule($t('page.system.post.form.postId.invalid')),
  deptId: createRequiredRule($t('page.system.post.form.deptId.invalid')),
  postCode: createRequiredRule($t('page.system.post.form.postCode.invalid')),
  postName: createRequiredRule($t('page.system.post.form.postName.invalid')),
  postSort: createRequiredRule($t('page.system.post.form.postSort.invalid')),
  status: createRequiredRule($t('page.system.post.form.status.invalid'))
};
  ...
  <NDrawer v-model:show="visible" :title="title" display-directive="show" :width="800" class="max-w-90%">
    <NDrawerContent :title="title" :native-scrollbar="false" closable>
      <NForm ref="formRef" :model="model" :rules="rules">
        <NFormItem :label="$t('page.system.post.belongDept')" path="deptId">
          <NTreeSelect
