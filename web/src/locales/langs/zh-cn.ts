  ...
  page: {
    ...
    system: {
      ...
      setting: {
        ...
        notifyMorningPushEnabled: '外部渠道推送（企微应用消息/群机器人）',
        notifyMorningTip:
          '工作日按配置时间汇总百炼 TokenPlan 坐席+共享包余量与重置日，推送给目标部门/用户；修改发送时间保存后即生效（同步定时任务调度）。站内通知始终发送，外部渠道需开启对应页签开关。',
        // 认证配置
