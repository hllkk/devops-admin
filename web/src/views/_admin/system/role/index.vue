          ...
          const authUserBtn = () => {
            return (
              <ButtonIcon
                ...
                tooltipContent={$t('page.system.role.assignUser')}
...
async function handleExport() {
  download('/system/role/export', searchParams.value, `${$t('page.system.role.title')}_${new Date().getTime()}.xlsx`);
}
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    ...
    <NCard :title="$t('page.system.role.listTitle')" :bordered="false" size="small" class="card-wrapper sm:flex-1-hidden">
