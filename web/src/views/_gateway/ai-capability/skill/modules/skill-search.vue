...
const model = defineModel<Api.Gateway.SkillSearchParams>('model', { required: true });
      ...
      <NCollapseItem :title="$t('common.search')" name="skill-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:8" :label="$t('page.gateway.skill.col.name')" path="name" class="pr-24px">
              <NInput
            ...
            <NFormItemGi span="24 s:12 m:8" :label="$t('page.gateway.skill.col.category')" path="category" class="pr-24px">
              <NInput
            ...
            <NFormItemGi span="24 s:12 m:8" :label="$t('page.gateway.skill.col.isActive')" class="pr-24px">
              <NSelect v-model:value="activeValue" clearable :options="activeOptions" :placeholder="$t('common.placeholderSelect')" />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:8" :label="$t('page.gateway.skill.col.isPublished')" class="pr-24px">
