...
func Routers() *gin.Engine {
	...
	}
	{
		...
		gatewayRouter.InitAdoptionRouter(PrivateGroup)           // AI 网关·覆盖率/采用度(/gateway/adoption/*)
		gatewayRouter.InitHealthRouter(PrivateGroup)             // AI 网关·健康检查(/gateway/health/*)
		gatewayRouter.InitReportRouter(PrivateGroup)             // AI 网关·效能报告(/gateway/report/*)
